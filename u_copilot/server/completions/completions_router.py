...
from u_copilot.open_ai.openai_models import (
    OpenAICompletion,
    OpenAIMessage,
)
from u_copilot.server.chat.chat_router import ChatBody, chat_completion
from u_copilot.server.utils.auth import authenticated
