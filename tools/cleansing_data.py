    ...
    for subdir, dirs, files in os.walk(source_dir):
        ...
        for file in files:
            ...
            if file_path.endswith('.html'):
                ...
                relative_path = os.path.relpath(subdir, source_dir)  # Preserve folder structure
                save_dir = os.path.join(target_dir, relative_path)
                ...
                save_path = os.path.join(save_dir, convert_path_to_url(file_path))  # Target PDF file path

                try:
                    # Copy the PDF file
                    shutil.copy2(source_path, save_path)  # copy2 preserves metadata (e.g., timestamps)
